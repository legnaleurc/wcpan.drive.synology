...
from ._upload_session import create_upload_session_store
...
async def _managed_webhook(
    network: Network, config: ServerConfig
) -> AsyncGenerator[None, None]:
...
async def _app_lifecycle(app: web.Application) -> AsyncGenerator[None, None]:
    ...
    async with AsyncExitStack() as stack:
        ...
        session_store = stack.enter_context(
            create_upload_session_store(tmp_dir=tmp_dir)
        )
