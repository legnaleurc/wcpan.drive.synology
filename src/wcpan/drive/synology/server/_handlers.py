...
def _record_to_response(record: NodeRecord) -> dict[str, Any]:
...
async def create_node(request: web.Request) -> web.Response:
    ...
    await enqueue_write(wq, partial(storage.upsert_node_and_emit_change, record))
...
async def delete_node(request: web.Request) -> web.Response:
    ...
    await enqueue_write(wq, partial(storage.delete_subtree_and_emit_changes, node_id))
